...
- [Logisim-Evolution](https://github.com/logisim-evolution/logisim-evolution) (recommended) or Logisim, version compatible with the file format used here.
...
3. Double-click the **Instruction\_Memory** RAM and load your program (hex machine code, one 32-bit word per address) using Logisim's "Load Image" option, or edit it directly in the RAM's hex editor.
...
6. Inspect register contents via the **Register\_File\_32** sub-circuit, and memory contents via the **Data\_Memory** RAM.
